...
<body>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            ...
            <h3>和未来的校友聊聊吧</h3>
            <br>
	    <a href="#about" class="btn btn-dark btn-lg">Tell Me More</a>
	    <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>宣传语1</h2>
                    <p class="lead">宣传语 <a target="_blank" href="http://join.deathtothestockphoto.com/">链接</a>.</p>
                </div>
            </div>
            <!-- /.row -->
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <hr class="small">
                    <p class="text-muted">Copyright &copy; 海友 2015</p>
                </div>
            </div>
        </div>
    </footer>
